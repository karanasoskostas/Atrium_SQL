...
select  1,
        ...
        1                   as updateuserid,
        now()               as updatedate
from spata.spata_001_b  a inner join ydr_consumers on a.diadromh = ydr_consumers.routesortlist
...
set hydrometerid =
       (select b.id
        ...
        where a.diadromh = ydr_consumers.routesortlist
        and b.code like '8SEN%')
where routesortlist in (select a.diadromh from spata.spata_001_b a)
and  (select b.id
        from spata.spata_001_b a
                 inner join ydr_hydrometers b on a.ydrom = b.code
        where a.diadromh = ydr_consumers.routesortlist
